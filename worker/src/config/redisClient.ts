...
export const connectionDetails: RedisOptions = {
...
/**
 * Shared queue names (keep constants here for clarity).
 */
export const TRANSACTION_QUEUE = 'notification_transactions';
export const DELAYED_NOTIFICATION_QUEUE = 'delayed_notifications';